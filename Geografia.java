...
public class Geografia {
    ...
    private static final String[] cidades = {"Curitiba", "Maringá", "Londrina", "Pinhais",
    ...
    public static String retornarCidades(String cidade) { //função que retorna as cidades
        ...
        switch (tratado) {
            ...
            case "FLORIANOPOLIS": {
                ret = "A cidade de Florianópolis" + sc + nCapital;
                break;
            }
            case "FLORIANPOLIS": {
                ret = "A cidade de Florianópolis" + sc + nCapital;
            ...
            case "PORTO ALEGRE": {
                ret = "A cidade de Porto Alegre" + sc + capital;
                break;
            }
            case "GRAMADO": {
                ret = "A cidade de Gramado" + sc + nCapital;
                break;
            }
            default: {
